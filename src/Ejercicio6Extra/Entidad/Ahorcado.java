...
package Ejercicio6Extra.Entidad;
...
public class Ahorcado {
    ...
    public Ahorcado(String[] buscar, int encontradas, int jugadasMaximas) {
        this.buscar = buscar;
    ...
    public String toString() {
        return "Ahorcado{" + "buscar=" + buscar + ", encontradas=" + encontradas + ", jugadasMaximas=" + jugadasMaximas + '}';
    }
