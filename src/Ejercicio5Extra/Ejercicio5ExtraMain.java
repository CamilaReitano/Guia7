...
import Ejercicio5Extra.Servicio.SreviceMeses;

public class Ejercicio5ExtraMain {

    public static void main(String[] args) {
       SreviceMeses smeses = new SreviceMeses();
       smeses.crearArrayMeses();
       smeses.crearMesSecreto();
       smeses.adivinarMes();
    }
